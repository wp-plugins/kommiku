...
<div class="wrap">
	...
	<h2><?php echo '<a href="'.$url.'admin.php?page=kommiku">'; ?><?_e('Series Listing', 'kommiku')?></a></h2>
	...
	<div class="metabox-holder has-right-sidebar" id="poststuff">
		<div class="inner-sidebar" id="side-info-column">
			<div class="meta-box-sortables ui-sortable" id="side-sortables">				
				<div class="postbox">
					<h3 style="cursor: default;"><span><?_e('Create a Series', 'kommiku')?></span></h3>
					<div class="inside">
						<div class="submitbox">
								...
								<div style="background: none;">
										<div style="margin-bottom: 10px;">
											<div class="misc-pub-section ">
												<span <?php if($series['fail']['title'])echo 'style="color: #ff0000;"'; ?>><?_e('Series Name:', 'kommiku')?></span> <input name="title" type="text" value="<?php if($_GET['action'] != 'delete') echo $series['title']; ?>" style="width: 150px; float: right; text-align: left;" />
												<div class="clear"></div> 
											</div>
											<div class="misc-pub-section ">
												<span <?php if($series['fail']['slug'])echo 'style="color: #ff0000;"'; ?>><?_e('Series Slug:', 'kommiku')?></span> <input name="slug" type="text" value="<?php if($_GET['action'] != 'delete') echo $series['slug']; ?>" style="width: 150px; float: right; text-align: left;" />
												<div class="clear"></div> 
											</div>
											<div class="misc-pub-section ">
												<?_e('Summary:', 'kommiku')?> <textarea name="summary" type="text" style="width: 150px; float: right; text-align: left;" /><?php if($_GET['action'] != 'delete') echo stripslashes($series['summary']); ?></textarea>
												<div class="clear"></div> 
											</div>
											<div class="misc-pub-section ">
												<?_e('Chapter-Less:', 'kommiku')?> <input type="checkbox" <?php if ($series['chapterless']) echo 'checked="checked" '; ?>value="1" name="chapterless"/>
												<div class="clear"></div> 
											</div>
										</div>
										<div class="clear"></div>
