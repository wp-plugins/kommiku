...
<div class="wrap">
	...
	<div class="metabox-holder has-right-sidebar" id="poststuff">	
		<div id="post-body-content">
			<div>
				<div class="postbox">
					<h3 style="cursor: default;"><span>Delete?! Are you sure?</span></h3>
					<div class="inside">
						<div class="submitbox">
							<div id="titlediv" style="margin: 0;">
								<div id="titlewrap">
									...
									<?php if (is_numeric($series['id']) && is_numeric($chapter['id']) && is_numeric($page['id'])) { 
										...
										<li>Are you sure you want to delete this Page?</li>
									<? } if (is_numeric($series['id']) && is_numeric($chapter['id']) && !is_numeric($page['id'])) { 
										//Series. On Chapter ?>
										<li><h4><?php echo $series['title'].' - Chapter '.$chapter_number; ?></h4></li>
										<li>Are you sure you want to delete this Chapter?</li>
										<li>All <strong>Pages</strong> within the Chapters will all be deleted</li>
									<? } if (is_numeric($series['id']) && !is_numeric($chapter['id']) && !is_numeric($page['id'])) { 
										//Just deleteing the Series? ?>
										<li><h4><?php echo $series['title'] ?></h4></li>
										<li>Are you sure you want to delete this Series?</li>
										<li>The <strong>Series</strong>, and <strong>ALL it's Content</strong> will all be deleted</li>
				...
				<div class="postbox">
					<h3 style="cursor: default;"><span>The Delete Button</span></h3>
					<div class="inside">
						<div class="submitbox">
							<div style="background: none;">
								<div class="clear"></div>
								<div style="width: 100%; float: right; text-align: right">
									<input name="delete" value="Delete It!" type="submit" style="float: right; margin: 5px;" class="button-primary"/>
								</div>
								<div class="clear"></div>
							</div>							
						</div>
